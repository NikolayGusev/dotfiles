...
- Not possible to get into terminal tabs unless there are two terminals open.
  - Add a hotkey to create a new terminal? Ideally should do this on "go to tabs" hotkey automagically.
